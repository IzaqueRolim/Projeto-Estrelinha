        ...
        {dark === false ? (
          <Table>
            ...
            {(hour === 13 && minutes >= 0) || (hour === 13 && minutes <= 50) ? (
              <Column2Destaque>
                {horarios[index].times.firstTime.name}
              </Column2Destaque>
            ) : (
            ...
            (hour === 14 && minutes <= 40) ? (
              <Column2Destaque>
                {horarios[index].times.secondTime.name}
              </Column2Destaque>
            ) : (
            ...
            (hour === 15 && minutes <= 30) ? (
              <Column2Destaque>
                {horarios[index].times.thirdTime.name}
              </Column2Destaque>
            ) : (
            ...
            (hour === 16 && minutes <= 20) ? (
              <Column2Destaque>
                {horarios[index].times.fourthTime.name}
              </Column2Destaque>
            ) : (
            ...
            (hour === 17 && minutes <= 10) ? (
              <Column2Destaque>
                {horarios[index].times.fifthTime.name}
              </Column2Destaque>
            ) : (
            ...
            {hour === 17 && minutes >= 10 ? (
              <Column2Destaque>
                {horarios[index].times.sixthTime.name}
              </Column2Destaque>
            ) : (
